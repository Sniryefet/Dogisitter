...
public class AdminProfile extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mUserID = getIntent().getExtras().getString("adminKey");
            //LINK DATABASE REFS
            ...
            if(mImageUri!=null){
                ...
                fileReference.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(com.sniryefet.Dogisitter.AdminProfile.this, "File Uploaded ", Toast. LENGTH_LONG ).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        mProgressDialog.dismiss ();
                        Toast.makeText(com.sniryefet.Dogisitter.AdminProfile.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
        ...
        private void loadRecyclerView(){
            ...
            mDatabaseRefDogs.child(mUserID).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mAdapter = new RecyclerViewAdapter(mUploads, com.sniryefet.Dogisitter.AdminProfile.this);
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(com.sniryefet.Dogisitter.AdminProfile.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
